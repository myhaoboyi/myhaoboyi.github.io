(function (d) {
	"function" === typeof define && define.amd ? define(["jquery", "datatables", "datatablesButtons"], function (e) {
		return d(e, window, document)
	}) : "object" === typeof exports ? module.exports = function (e, a) {
		e || (e = window);
		if (!a || !a.fn.dataTable) a = require("datatables")(e, a).$;
		a.fn.dataTable.Buttons || require("datatablesButtons")(e, a);
